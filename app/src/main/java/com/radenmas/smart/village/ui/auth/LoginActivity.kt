package com.radenmas.smart.village.ui.auth
...
import com.radenmas.smart.village.databinding.ActivityLoginBinding
import com.radenmas.smart.village.ui.admin.AdminMainActivity
import com.radenmas.smart.village.ui.user.UserMainActivity
                    ...
                    .addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.exists()) {
                                ...
                                when (role) {
                                    "admin" -> {
                                        Utils.toast(this@LoginActivity, "Berhasil masuk")
